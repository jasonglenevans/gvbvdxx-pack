...
$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,e){a!=Array.prototype&&a!=Object.prototype&&(a[b]=e.value)};
...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function e(a){return a instanceof c?a:new c(function(b,g){b(a)})}if(a&&!$jscomp.FORCE_POLYFILL_PROMISE)return a;b.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};b.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(a){d(a,
...
(function(){var a=function(a){if("log"==a)return{log:function(a){console.log("%c[Gvbvdxx Pack Script]:"+a,"color:black;font-weight:bold;")},warn:function(a){console.warn("%c[Gvbvdxx Pack Script]:"+a,"color:#e67700;font-weight:bold;background:#fcc419;")},error:function(a){console.error("%c[Gvbvdxx Pack Script]:"+a,"color:#f03e3e;font-weight:bold;background:#c92a2a;")}};if("HTMLEmmitter"==a)return a=function(){},a.prototype.writeHTML=function(a,b){b=b?b:document.body;b.innerHTML+=a},a;if("file-loader"==
a)return{readFile:function(a){for(var c in b)if(b[c].realdirNoReplacer.replaceAll("\\","/")==a)return b[c].data;return null}};for(var c in b)if(b[c].realdirNoReplacer.replaceAll("\\","/")==a)return eval(b[c].data);throw Error("Unable To Find Module "+a);},b={},e={log:function(a,b){console.log("%c["+a+"]:"+b,"color:black;font-weight:bold;")},warn:function(a,b){console.warn("%c["+a+"]:"+b,"color:#ffa94d;font-weight:bold;background:#d9480f;")},error:function(a,b){console.error("%c["+a+"]:"+b,"color:#ff8787;font-weight:bold;background:#c92a2a;")}};
(function(){var a,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(fetch("./gvbvdxxpack_files.json?n=1"),2);if(3!=c.nextAddress)return a=c.yieldResult,c.yield(a.text(),3);b=c.yieldResult;return c.return(b)})})().then(function(d){b=JSON.parse(d).fileTemplate;e.log("Gvbvdxx Pack","Loaded Files");a("src/index.js")})})();